...
<section class="video-hero relative">
	<video src="http://getprotectionpro.com/wp-content/uploads/2017/08/Protection-Pro-Homepage-480-DA.mp4" autoplay="" loop="" muted="" preload="auto"></video>
	<a href="<?php echo site_url(); ?>" class="logo absolute"><img src="<?php bloginfo('template_directory'); ?>/src/assets/images/white-logo.png" alt="<?php bloginfo('title'); ?>"></a>
...
<section class="who">
	<div class="grid-container">
		<div class="grid-x relative">
			...
			<img src="<?php bloginfo('template_directory'); ?>/src/assets/images/orange-benches.png" class="absolute" alt="marketing in color who we are">
		</div>
	</div>
</section>
...
<section class="what">
	<div class="grid-container">
		<div class="grid-x grid-margin-x relative">
			<div class="absolute purple-box"></div>
