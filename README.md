# MIC Website Built on FoundationPress

URL: https://marketingincolor.com
Developer(s): [Nate Beers](https://github.com/nbeers22) & [Edd Twilbeck](https://github.com/eddt)
Organization: [Marketing in Color](https://github.com/marketingincolor)
...
$ git clone git@github.com:marketingincolor/foundationpress-mic.git
$ cd foundationpress-mic
$ npm install
```
...
The `/template-parts` folder contains parts of templates that can be inserted into the code at a particular time.

### Styles and Sass Compilation

 * `style.css`: Do not worry about this file. (For some reason) it's required by WordPress. All styling is handled in the Sass files described below
